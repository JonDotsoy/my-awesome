...
- [Slash](https://fintoc.me/) - Esta herramienta es perfecta para compartir la información de datos de transferencia bancaria sin tener que enviarla de manera indirecta. En Chile, para hacer una transferencia a una cuenta bancaria de otra persona se necesita demasiada información, y Slash lo simplifica mediante un simple URL que agrupa toda la información necesaria, permitiendo al usuario copiar y pegar los datos de transferencia rápidamente.
